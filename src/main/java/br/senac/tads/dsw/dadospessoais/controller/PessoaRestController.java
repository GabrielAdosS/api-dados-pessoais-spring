...
public class PessoaRestController {
    ...
    @GetMapping("/apelido")
    public PessoaDto findByUsernameRequesParam(
            @RequestParam(value = "username", defaultValue = "fulano") String u) {
        return service.findByUsername(u);
    }

    @GetMapping("/{username}")
    public PessoaDto findByUsername(@PathVariable("username") String u) {
        PessoaDto resultado = service.findByUsername(u);
        if (resultado == null) {
    ...
    @PostMapping
    public ResponseEntity<?> addNew(@RequestBody @Valid PessoaDto pessoa) {
        PessoaDto p = service.addNew(pessoa);
